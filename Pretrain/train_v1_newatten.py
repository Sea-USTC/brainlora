...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', default='/remote-home/jianghaoyun/UniBrain-v2_new/Pretrain/output_dir/output_onefifth_v1_newatten_3')
    parser.add_argument('--device', default='cuda')
    parser.add_argument('--gpu', type=str,default='1,2', help='gpu')
