...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default='/remote-home/jianghaoyun/UniBrain-v2_new/Pretrain/configs/config_complete.yaml')
    parser.add_argument('--finetune_checkpoint', default='')
    parser.add_argument('--output_dir', default='/remote-home/jianghaoyun/UniBrain-v2_new/Pretrain/output_complete/output_mixup')
