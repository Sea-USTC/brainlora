...
class MultiheadAttention_newatten(Module):
    ...
    def __init__(self, embed_dim, num_heads, dropout=0., bias=True, add_bias_kv=False, add_zero_attn=False,
        ...
        self.kv_proj_linear = nn.Linear(embed_dim, embed_dim)
        # self.kv_proj = MultiLoRALinear(r=[2,4,8],lora_alpha=1, linear_layer=self.kv_proj_linear,lora_num=3)
        ...
        self.multihead_forward = multi_head_attention_forward_newatten
    ...
    def _reset_parameters(self):
        ...
        constant_(self.kv_proj_linear.bias, 0.)
    ...
    Outputs:
        ...
        if not self._qkv_same_embed_dim:
            attn_output, attn_output_weights = self.multihead_forward(
                ...
                self.q_proj, self.kv_proj_linear,
                self.add_zero_attn,
...
def multi_head_attention_forward_newatten(
    query: Tensor,
    key: Tensor,
    value: Tensor,
    ...
    """
    tens_ops = (query, key, value, q_proj, kv_proj_linear, out_proj_weight, out_proj_bias, bias_k, bias_v)
    if has_torch_function(tens_ops):
        return handle_torch_function(
            multi_head_attention_forward_newatten,
            tens_ops,
            query,
            key,
            value,
