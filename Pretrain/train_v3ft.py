...
def main(args, config):
    ...
    for param in image_encoder.module.res_l1.lora_B.parameters():
        param.requires_grad=True
    for param in image_encoder.module.res_l2.lora_A.parameters():
        param.requires_grad=True
    for param in image_encoder.module.res_l2.lora_B.parameters():
        param.requires_grad=True
