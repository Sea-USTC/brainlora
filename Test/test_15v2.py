...
def test(args,config):
    ...
    xlsx_folder_path = '/root/UniBrain-lora/Test/xlsx_files_lorav3r8/'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default='/root/output_fifteen/output_lorav3_r8/config.yaml')
    parser.add_argument('--model_path', default='/root/output_fifteen/output_lorav3_r8/best_val.pth')
