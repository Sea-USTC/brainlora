...
def test(args,config):
    ...
    xlsx_folder_path = '/remote-home/mengxichen/UniBrain-lora/Test/xlsx_files_base2/'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', default='/remote-home/mengxichen/UniBrain-lora/Pretrain/output_fifteen/output_baseline2/best_val.pth')
