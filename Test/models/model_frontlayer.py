...
class MedKLIP_frontlayer(nn.Module):

    def __init__(self, config, mode='train'):
        super(MedKLIP_frontlayer, self).__init__()
        ...
        self.decoder = TransformerDecoder(decoder_layer, config['N']-1 , self.decoder_norm,
