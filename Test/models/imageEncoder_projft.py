...
from models.projft_lora import LoRAProj
...
class ModelRes(nn.Module):
    def __init__(self, config):
        ...
        self.res_l1 = LoRAProj(config['r_proj'], config['lora_alpha'], num_ftrs, num_ftrs)
        self.res_l2 = LoRAProj(config['r_proj'], config['lora_alpha'], num_ftrs, out_feature)
