...
class BraTS(Dataset):
    def __init__(self, csv_path, np_path,report_observe,mode = 'train', augmentation = False, fid_ex=[]):
    ...
    def __getitem__(self, index):
        ...
        for modal in modal_dic:
            ...
            image = nnUNet_resample(data,[224,224,24],True,"normal")
            images.append(image)
        images = np.stack(images, -1)

        if fid in self.report:
        ...
        sample = {'image': images, 'label': labels, "fid":fid, 'entity':entity}
