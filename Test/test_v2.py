...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default='/remote-home/jianghaoyun/UniBrain-v2_new/Test/configs/config_half.yaml')
    parser.add_argument('--model_path', default='/remote-home/jianghaoyun/UniBrain-v2_new/Pretrain/output_dir/output_half_detach_new/best_val.pth')
