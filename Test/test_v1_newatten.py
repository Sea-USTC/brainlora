...
from models.model_newatten import MedKLIP as MedKLIP
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', default='/remote-home/jianghaoyun/UniBrain-v2_new/Pretrain/output_dir/output_onefifth_v1_newatten_3/best_val.pth')
